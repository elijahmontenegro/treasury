...
250 labels, 0 the reader found nothing on, latency median 1.4s p95 4.6s

| claim | n | precision | recall | review | mismatch found | not found on missing |
|---|---|---|---|---|---|---|
| brand | 131 | 1.00 | 0.78 | 0.00 | 0/6 | 0 |
...
| producer_1 | 55 | 0.22 | 195 | 0.22 |
| producer_2 | 55 | 0.31 | 195 | 0.36 |
| origin | 58 | 0.62 | 192 | 0.61 |
...
| vertical warning | 41 | 0 | 0.50 |
| crowded warning | 46 | 0 | 0.49 |
